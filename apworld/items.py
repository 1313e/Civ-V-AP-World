...
PROGRESSIVE_TECH_ITEMS = [
    CivVItemData(
        ...
        type=CivVItemType.tech,
        game_id=[1, 19, 22, 46, 47, 60],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Production",
        type=CivVItemType.tech,
        game_id=[4, 10, 24, 43, 64],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Science",
        type=CivVItemType.tech,
        game_id=[7, 26, 42, 56, 76],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Culture",
        type=CivVItemType.tech,
        game_id=[16, 17, 32, 41, 52, 68, 74],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Gold",
        type=CivVItemType.tech,
        game_id=[2, 18, 23, 33, 38, 48],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Happiness",
        type=CivVItemType.tech,
        game_id=[6, 8, 15, 34, 51],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Exploration",
        type=CivVItemType.tech,
        game_id=[5, 12, 25, 31, 71],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Melee Unit",
        type=CivVItemType.tech,
        game_id=[11, 13, 20, 27, 30, 35, 39, 44, 45, 49, 53, 59, 63, 67, 69, 73, 77, 78],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Ranged Unit",
        type=CivVItemType.tech,
        game_id=[3, 28, 36, 54, 57, 58, 62, 72, 79],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Siege Unit",
        type=CivVItemType.tech,
        game_id=[14, 29, 40, 50, 66, 70],
        classification=ItemClassification.progression,
    ),
    CivVItemData(
        name="Progressive Misc",
        type=CivVItemType.tech,
        game_id=[9, 21, 37, 55, 61, 65, 75],
        classification=ItemClassification.progression,
    ),
]
