...
WORLD_WONDER_LOCATIONS = [
    ...
    # TODO: Add requirements to all world wonders
    CivVLocationData(name="Great Lighthouse", type=CivVLocationType.world_wonder, game_id=63),
    CivVLocationData(name="Stonehenge", type=CivVLocationType.world_wonder, game_id=64),
    CivVLocationData(name="Great Library", type=CivVLocationType.world_wonder, game_id=65),
    CivVLocationData(name="Pyramids", type=CivVLocationType.world_wonder, game_id=66),
    CivVLocationData(name="Colossus", type=CivVLocationType.world_wonder, game_id=67),
    CivVLocationData(name="Oracle", type=CivVLocationType.world_wonder, game_id=68),
    CivVLocationData(name="Hanging Gardens", type=CivVLocationType.world_wonder, game_id=69),
    CivVLocationData(name="Great Wall", type=CivVLocationType.world_wonder, game_id=70),
    CivVLocationData(name="Angkor Wat", type=CivVLocationType.world_wonder, game_id=71),
    CivVLocationData(name="Hagia Sophia", type=CivVLocationType.world_wonder, game_id=72),
    CivVLocationData(name="Chichen Itza", type=CivVLocationType.world_wonder, game_id=73),
    CivVLocationData(name="Machu Pichu", type=CivVLocationType.world_wonder, game_id=74),
    CivVLocationData(name="Notre Dame", type=CivVLocationType.world_wonder, game_id=75),
    CivVLocationData(name="Porcelain Tower", type=CivVLocationType.world_wonder, game_id=76),
    CivVLocationData(name="Himeji Castle", type=CivVLocationType.world_wonder, game_id=77),
    CivVLocationData(name="Sistine Chapel", type=CivVLocationType.world_wonder, game_id=78),
    CivVLocationData(name="Kremlin", type=CivVLocationType.world_wonder, game_id=79),
    CivVLocationData(name="Forbidden Palace", type=CivVLocationType.world_wonder, game_id=80),
    CivVLocationData(name="Taj Mahal", type=CivVLocationType.world_wonder, game_id=81),
    CivVLocationData(name="Big Ben", type=CivVLocationType.world_wonder, game_id=82),
    CivVLocationData(name="Louvre", type=CivVLocationType.world_wonder, game_id=83),
    CivVLocationData(name="Brandenburg Gate", type=CivVLocationType.world_wonder, game_id=84),
    CivVLocationData(name="Statue of Liberty", type=CivVLocationType.world_wonder, game_id=85),
    CivVLocationData(name="Cristo Redentor", type=CivVLocationType.world_wonder, game_id=86),
    CivVLocationData(name="Eiffel Tower", type=CivVLocationType.world_wonder, game_id=87),
    CivVLocationData(name="Pentagon", type=CivVLocationType.world_wonder, game_id=88),
    CivVLocationData(name="Sydney Opera House", type=CivVLocationType.world_wonder, game_id=90),
    CivVLocationData(name="Status of Zeus", type=CivVLocationType.world_wonder, game_id=93),
    CivVLocationData(name="Temple of Artemis", type=CivVLocationType.world_wonder, game_id=94),
    CivVLocationData(name="Mausoleum of Halicarnassus", type=CivVLocationType.world_wonder, game_id=95),
    CivVLocationData(name="Alhambra", type=CivVLocationType.world_wonder, game_id=128),
    CivVLocationData(name="CN Tower", type=CivVLocationType.world_wonder, game_id=129),
    CivVLocationData(name="Hubble Space Telescope", type=CivVLocationType.world_wonder, game_id=130),
    CivVLocationData(name="Leaning Tower of Pisa", type=CivVLocationType.world_wonder, game_id=131),
    CivVLocationData(name="Mosque of Djenne", type=CivVLocationType.world_wonder, game_id=132),
    CivVLocationData(name="Neuschwanstein", type=CivVLocationType.world_wonder, game_id=133),
    CivVLocationData(name="Petra", type=CivVLocationType.world_wonder, game_id=134),
    CivVLocationData(name="Terracotta Army", type=CivVLocationType.world_wonder, game_id=135),
    CivVLocationData(name="Great Firewall", type=CivVLocationType.world_wonder, game_id=136),
    CivVLocationData(name="Uffizi", type=CivVLocationType.world_wonder, game_id=154),
    CivVLocationData(name="Globe Theatre", type=CivVLocationType.world_wonder, game_id=155),
    CivVLocationData(name="Broadway", type=CivVLocationType.world_wonder, game_id=156),
    CivVLocationData(name="Red Fort", type=CivVLocationType.world_wonder, game_id=157),
    CivVLocationData(name="Prora", type=CivVLocationType.world_wonder, game_id=158),
    CivVLocationData(name="Borobudur", type=CivVLocationType.world_wonder, game_id=159),
    CivVLocationData(name="Parthenon", type=CivVLocationType.world_wonder, game_id=160),
    CivVLocationData(name="International Space Station", type=CivVLocationType.world_wonder, game_id=161),
]
"List of all world wonder locations within Civ V"
